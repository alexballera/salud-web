...
/// SERVICES END
function ExamResultsDetailPage({ handleNotifications }: TPersonalDataProps): JSX.Element {
...
export default withTranslation([i18Global, i18Forms])(withAppContext(ExamResultsDetailPage));
