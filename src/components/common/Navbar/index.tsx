...
function Navbar(): JSX.Element {
  ...
  const showMenu = () => {
    switch (router.pathname) {
      ...
      case '/medicalDirectory/searchBy/search_by_specialty':
        return false;
      case '/medicalDirectory/searchBy/specialtyResults':
        return false;
      case '/':
        return true;
      case '/proceedings':
  ...
  const customRedirectList = {
    ...
    '/medicalDirectory/searchBy/search_by_specialty': '/medicalDirectory',
    '/medicalDirectory/searchBy/specialtyResults': '/medicalDirectory/searchBy/search_by_specialty'
  };
